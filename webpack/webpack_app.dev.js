    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            ...
            'process.env': {
                ...
                'USERS_DOMAIN': JSON.stringify('http://52.74.44.15:8070/api/users/'),
                'EVENTS_DOMAIN': JSON.stringify('http://52.74.44.15:8072/api/events/s/v1/'),
                'ASSETS_DOMAIN': JSON.stringify('http://52.74.44.15:8071/api/assets/s/v1/'),
                'DCE_DOMAIN': JSON.stringify('http://52.76.28.80:8070/api/dce/s/v1/'),

                //  'USERS_DOMAIN': JSON.stringify('http://54.255.203.29:8070/api/users/'),

                // 'USERS_DOMAIN': JSON.stringify('http://192.168.7.23:8070/api/users/p/v1/'),
                // 'EVENTS_DOMAIN': JSON.stringify('http://192.168.7.23:8072/api/events/s/v1/'),
                // 'ASSETS_DOMAIN': JSON.stringify('http://192.168.7.23:8071/api/v1/'),
                ...
                'APP_VERSION': JSON.stringify(APP_VERSION.config.APP_DEV_VERSION),
                ...
                // 'EVENTS_DOMAIN': JSON.stringify('http://192.168.7.23:8072/api/v1/'),
                // 'ASSETS_DOMAIN': JSON.stringify('http://192.168.7.23:8071/api/assets/s/v1/'),
                // 'DCE_DOMAIN': JSON.stringify('http://192.168.7.23:8073/api/dce/v1/'),
